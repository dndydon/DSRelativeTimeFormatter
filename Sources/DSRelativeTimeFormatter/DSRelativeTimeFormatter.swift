...
// MARK: - TimeInterval convenience constants
public extension TimeInterval {
  ...
  /// Average month length in seconds (30.436875 days)
  static let month:  TimeInterval = 30.436875 * day
  /// Average year length in seconds (365.2425 days)
  static let year:   TimeInterval = 365.2425 * day
}
